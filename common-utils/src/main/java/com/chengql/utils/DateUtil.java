...
public class DateUtil {
    ...
    static SimpleDateFormat formatyyyyMMddHHmmssSSS = new SimpleDateFormat(yyyyMMddHHmmssSSS);
    ...
    static SimpleDateFormat formatyyyyMMString = new SimpleDateFormat(yyyyMMString);
    static SimpleDateFormat formatyyyyMMddString = new SimpleDateFormat(yyyyMMddString);
    // 时间格式
    static String[] parsePatterns = { "yyyy-MM-dd", "yyyy年MM月dd日", "yyyy-MM-dd HH:mm:ss", "yyyy-MM-dd HH:mm", "yyyy/MM/dd", "yyyy/MM/dd HH:mm:ss", "yyyy/MM/dd HH:mm", "yyyyMMdd" };
    ...
    public static String get_yyyyMMddHHmm() {
        return new DateTime().toString(yyyyMMddHHmm);
    }
    ...
    public static Date getEndOfDate(Date date) {
        try {
            return new SimpleDateFormat("yyyy-MM-dd HH:mm:ss").parse(new SimpleDateFormat("yyyy-MM-dd 23:59:59").format(date));
        } catch (ParseException e) {
            return null;
        }
    }
